...
class RecurringIncomeTest {
    ...
    private RecurringIncome riTest1 = new RecurringIncome("paycheck", 1500, "bi-weekly");
    private RecurringIncome riTest2 = new RecurringIncome("renter's", 1100, "monthly");
    private RecurringIncome riTest3 = new RecurringIncome("fun money", 50, "weekly");
